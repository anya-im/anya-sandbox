...
class AnyaAE(nn.Module):
    def __init__(self, in_dim, hidden_m_dim=256, hidden_s_dim=128, z_dim=32):
        ...
        self._en_lstm = nn.LSTM(hidden_m_dim, hidden_m_dim, batch_first=True)
        self._en_hid_layer1 = nn.Linear(hidden_m_dim, hidden_m_dim)
        self._en_hid_layer2 = nn.Linear(hidden_m_dim, hidden_s_dim)
        ...
        self._de_hid_layer2 = nn.Linear(hidden_m_dim, hidden_m_dim)
        self._de_lstm = nn.LSTM(hidden_m_dim, hidden_m_dim, batch_first=True)
